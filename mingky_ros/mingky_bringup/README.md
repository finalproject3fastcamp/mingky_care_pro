...
footprint 외곽부터 점유 셀까지의 여유를 계산합니다. **4cm 미만은 차단**하고,
**4cm 이상 8cm 미만은 경고**합니다. 관제의 Waypoint Check도 같은 기준을
...
ros2 run mingky_bringup check_waypoints.py --tolerance 0.07 \
  --minimum-clearance 0.04 --margin 0.08 --padding 0.01
```
